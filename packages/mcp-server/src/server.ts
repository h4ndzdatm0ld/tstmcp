...
import { ClientOptions } from 'devknot';
...
export { ClientOptions } from 'devknot';
...
export function initMcpServer(params: {
  ...
  const client = new Devknot(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Devknot({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
